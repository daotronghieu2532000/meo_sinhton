...
""";
          ...
          : RefreshIndicator(
              ...
              child: _topTips.isEmpty
                  ? Center(
                      child: Text(
                        _tr(
                          vi: 'Chưa có góp ý nổi bật',
                          en: 'No top tips yet',
                          pl: 'Brak wyróżnionych porad',
                        ),
                      ),
                    )
                  : ListView.builder(
                      ...
                      itemCount:
                          _topTips.length + (_topTips.length >= 3 ? 1 : 0),
                      itemBuilder: (context, index) {
                        if (_topTips.length >= 3 && index == 0) {
                          return _buildPodiumBanner();
                        }
                        final actualIndex = _topTips.length >= 3
                            ? index - 1
                            : index;
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        ...
        gradient: LinearGradient(
          ...
          colors: [Color(0xFF1A1A40), Color(0xFF0F0C29)],
        ),
      ),
      child: Stack(
        children: [
                    ...
                    Container(
                      ...
                      child: CircleAvatar(
                        ...
                        backgroundImage:
                            ...
                            : (tip['image_url'] != null
                                  ? NetworkImage(tip['image_url'])
                                  : null),
                        child:
                            (tip['images'] == null ||
                                    (tip['images'] as List).isEmpty) &&
                                tip['image_url'] == null
                            ? Icon(
                                Icons.person,
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        _getFlagEmoji(tip['country_code'] ?? 'VN'),
  ...
  Widget _buildTopTipCard(Map<String, dynamic> tip, int index) {
    ...
    if (index == 0)
      ...
      rankColor = Theme.of(context).colorScheme.outlineVariant;
            ...
            child: Row(
              ...
              children: [
                ...
                _buildActionButton(
                  ...
                  label: _tr(vi: 'Bình luận', en: 'Comment', pl: 'Komentarz'),
                  color: Theme.of(context).colorScheme.onSurfaceVariant,
                  onTap: () {
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: widget.isZoomMode
                        ? null
                        : () {
                            _TopTipsPageState parent = context
                                .findAncestorStateOfType<_TopTipsPageState>()!;
